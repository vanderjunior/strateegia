...
class ExplicitCommitDecisionSummary(BaseModel):
    summary_id: str
    decision_type: str = "mark_not_reviewed"
    decision_state: str = "decision_not_reviewed"
    reviewer_id: str | None = None
    reason: str = ""
    decision_recorded: bool = False
    approved_for_future_mutation_commit_review: bool = False
    approved_for_commit_now: bool = False
    denied: bool = False
    revision_requested: bool = False
    blocked: bool = False
    created_at: datetime = Field(default_factory=utc_now)
...
class ExplicitCommitConfirmationSummary(BaseModel):
    summary_id: str
...
class ExplicitCommitDeltaApproval(BaseModel):
    approval_id: str
    source_delta_decision_id: str | None = None
    source_delta_id: str | None = None
    target_type: str = "unknown"
    delta_kind: str = "unknown"
    source_commit_decision: str = "delta_needs_review"
    source_committed: bool = False
    explicitly_approved: bool = False
    approved_for_future_mutation_commit_review: bool = False
    approved_for_commit_now: bool = False
    committed: bool = False
    approval_state: str = "delta_not_reviewed"
    blockers: list[str] = Field(default_factory=list)
    warnings: list[str] = Field(default_factory=list)
    metadata: dict[str, object] = Field(default_factory=dict)


class ExplicitCommitSurfaceApproval(BaseModel):
    approval_id: str
    source_surface_decision_id: str | None = None
    source_update_id: str | None = None
    surface_type: str = "unknown"
    update_kind: str = "unknown"
    source_commit_decision: str = "surface_needs_review"
    source_committed: bool = False
    explicitly_approved: bool = False
    approved_for_future_mutation_commit_review: bool = False
    approved_for_commit_now: bool = False
...
class ExplicitCommitAuditEntry(BaseModel):
    audit_id: str
    event_type: str
    actor_user_id: str | None = None
    message: str
...
class ExplicitCommitBlocker(BaseModel):
    blocker_id: str
    code: str
    severity: str = "blocked"
    message: str
...
class ExplicitCommitValidationFinding(BaseModel):
    finding_id: str
    code: str
    severity: str = "info"
    message: str
...
class ExplicitCommitWarning(BaseModel):
    code: str
    message: str
    severity: str = "warning"
    related_artifact_type: str | None = None
...
class SimuladoExplicitRuntimeMutationCommit(BaseModel):
    ...
    source_attempt_session_id: str | None = None
    source_simulado_blueprint_id: str | None = None
    decision_status: str = "explicit_commit_not_reviewed"
    readiness_state: str = "explicit_commit_needs_review"
    decision_summary: ExplicitCommitDecisionSummary
    confirmation_summary: ExplicitCommitConfirmationSummary
    delta_approvals: list[ExplicitCommitDeltaApproval] = Field(default_factory=list)
    surface_approvals: list[ExplicitCommitSurfaceApproval] = Field(default_factory=list)
    audit_trail: list[ExplicitCommitAuditEntry] = Field(default_factory=list)
    blockers: list[ExplicitCommitBlocker] = Field(default_factory=list)
    validation_findings: list[ExplicitCommitValidationFinding] = Field(default_factory=list)
    warnings: list[ExplicitCommitWarning] = Field(default_factory=list)
    explicit_commit_recorded: bool = False
    explicit_commit_approved: bool = False
    approved_for_future_mutation_commit_review: bool = False
    approved_for_commit_now: bool = False
    commit_request_accepted: bool = False
    commit_ready_for_execution: bool = False
...
class RuntimeCommitTransactionValidationSummary(BaseModel):
    summary_id: str
    source_explicit_commit_present: bool = True
    explicit_commit_recorded: bool = False
    explicit_commit_approved: bool = False
    approved_for_future_mutation_commit_review: bool = False
    approved_for_commit_now: bool = False
    confirmations_satisfied: bool = False
    source_commit_shell_present: bool = False
    source_commit_shell_pre_commit_only: bool = False
    source_mutation_transaction_present: bool = False
    planned_progress_commit_count: int = 0
    planned_surface_commit_count: int = 0
    rollback_execution_plan_available: bool = False
    rollback_execution_plan_verified: bool = False
    transaction_valid_for_execution: bool = False
    transaction_execution_ready: bool = False
    unsafe_public_answer_key_exposure_detected: bool = False
    unsafe_gabarito_exposure_detected: bool = False
    metadata: dict[str, object] = Field(default_factory=dict)


class PlannedProgressCommit(BaseModel):
    planned_commit_id: str
    source_delta_approval_id: str | None = None
    source_delta_decision_id: str | None = None
    source_delta_id: str | None = None
    target_type: str = "unknown"
    target_id: str | None = None
    delta_kind: str = "unknown"
    planned_commit_kind: str = "unknown"
    proposed_before_summary: dict[str, object] = Field(default_factory=dict)
    proposed_after_summary: dict[str, object] = Field(default_factory=dict)
    planned_delta_value: float | None = None
    confidence: float = 0.0
    committed: bool = False
...
class PlannedRuntimeSurfaceCommit(BaseModel):
    planned_commit_id: str
    source_surface_approval_id: str | None = None
    source_surface_decision_id: str | None = None
    source_update_id: str | None = None
...
class RuntimeCommitRollbackExecutionPlan(BaseModel):
    rollback_execution_plan_id: str
    rollback_required: bool = True
    rollback_available: bool = False
    rollback_verified: bool = False
...
class RuntimeCommitTransactionAuditEntry(BaseModel):
    audit_id: str
    event_type: str
    actor_user_id: str | None = None
    message: str
...
class RuntimeCommitTransactionBlocker(BaseModel):
    blocker_id: str
    code: str
    severity: str = "blocked"
    message: str
...
class RuntimeCommitTransactionValidationFinding(BaseModel):
    finding_id: str
    code: str
    severity: str = "info"
    message: str
...
class RuntimeCommitTransactionWarning(BaseModel):
    code: str
    message: str
    severity: str = "warning"
    related_artifact_type: str | None = None
...
class SimuladoRuntimeMutationCommitTransaction(BaseModel):
    ...
    source_attempt_session_id: str | None = None
    source_simulado_blueprint_id: str | None = None
    commit_transaction_mode: str = "commit_plan_only"
    commit_transaction_status: str = "commit_blocked"
    readiness_state: str = "commit_transaction_needs_review"
    validation_summary: RuntimeCommitTransactionValidationSummary
    planned_progress_commits: list[PlannedProgressCommit] = Field(default_factory=list)
    planned_surface_commits: list[PlannedRuntimeSurfaceCommit] = Field(default_factory=list)
    rollback_execution_plan: RuntimeCommitRollbackExecutionPlan
    audit_trail: list[RuntimeCommitTransactionAuditEntry] = Field(default_factory=list)
    blockers: list[RuntimeCommitTransactionBlocker] = Field(default_factory=list)
    validation_findings: list[RuntimeCommitTransactionValidationFinding] = Field(default_factory=list)
    warnings: list[RuntimeCommitTransactionWarning] = Field(default_factory=list)
    commit_transaction_created: bool = True
...
class ExplicitExecutionApprovalDecisionSummary(BaseModel):
    summary_id: str
    decision_type: str = "mark_not_reviewed"
    decision_state: str = "decision_not_reviewed"
    reviewer_id: str | None = None
    reason: str = ""
    decision_recorded: bool = False
    approved_for_future_commit_execution_review: bool = False
...
class ExplicitExecutionApprovalConfirmationSummary(BaseModel):
    summary_id: str
...
class ExplicitProgressExecutionApproval(BaseModel):
    approval_id: str
    source_check_id: str
    source_planned_commit_id: str
    target_type: str = "unknown"
    delta_kind: str = "unknown"
    source_execution_check_state: str = "progress_commit_execution_blocked"
    source_execution_allowed: bool = False
    ...
    approved_for_execution_now: bool = False
    executed: bool = False
    approval_state: str = "progress_execution_not_reviewed"
    blockers: list[str] = Field(default_factory=list)
    warnings: list[str] = Field(default_factory=list)
    metadata: dict[str, object] = Field(default_factory=dict)


class ExplicitSurfaceExecutionApproval(BaseModel):
    approval_id: str
    source_check_id: str
    source_planned_commit_id: str
    surface_type: str = "unknown"
    update_kind: str = "unknown"
    source_execution_check_state: str = "surface_commit_execution_blocked"
    source_execution_allowed: bool = False
    source_executed: bool = False
    explicitly_approved: bool = False
    approved_for_future_commit_execution_review: bool = False
    approved_for_execution_now: bool = False
    executed: bool = False
    approval_state: str = "surface_execution_not_reviewed"
    blockers: list[str] = Field(default_factory=list)
    warnings: list[str] = Field(default_factory=list)
    metadata: dict[str, object] = Field(default_factory=dict)


class ExplicitExecutionApprovalAuditEntry(BaseModel):
    audit_id: str
    event_type: str
    actor_user_id: str | None = None
    message: str
...
class ExplicitExecutionApprovalBlocker(BaseModel):
    blocker_id: str
    code: str
    severity: str = "blocked"
    message: str
...
class ExplicitExecutionApprovalValidationFinding(BaseModel):
    finding_id: str
    code: str
    severity: str = "info"
    message: str
...
class ExplicitExecutionApprovalWarning(BaseModel):
    code: str
    message: str
    severity: str = "warning"
    related_artifact_type: str | None = None
...
class SimuladoExplicitRuntimeCommitExecutionApproval(BaseModel):
    ...
    source_attempt_session_id: str | None = None
    source_simulado_blueprint_id: str | None = None
    decision_status: str = "explicit_execution_approval_not_reviewed"
    readiness_state: str = "explicit_execution_approval_needs_review"
    ...
    progress_execution_approvals: list[ExplicitProgressExecutionApproval] = Field(
        default_factory=list
    )
    surface_execution_approvals: list[ExplicitSurfaceExecutionApproval] = Field(
        default_factory=list
    )
    audit_trail: list[ExplicitExecutionApprovalAuditEntry] = Field(default_factory=list)
    blockers: list[ExplicitExecutionApprovalBlocker] = Field(default_factory=list)
    validation_findings: list[ExplicitExecutionApprovalValidationFinding] = Field(
        default_factory=list
    )
    warnings: list[ExplicitExecutionApprovalWarning] = Field(default_factory=list)
    explicit_execution_approval_recorded: bool = False
    explicit_execution_approved: bool = False
    approved_for_future_commit_execution_review: bool = False
    approved_for_execution_now: bool = False
    commit_execution_allowed: bool = False
    commit_execution_started: bool = False
...
class RuntimeCommitExecutionPlanSummary(BaseModel):
    summary_id: str
    source_approval_present: bool = False
    source_approval_recorded: bool = False
    source_approval_future_review_approved: bool = False
    source_approved_for_execution_now: bool = False
    confirmations_satisfied: bool = False
    progress_approval_count: int = 0
    surface_approval_count: int = 0
    approved_progress_step_count: int = 0
    approved_surface_step_count: int = 0
    planned_phase_count: int = 0
    rollback_checkpoint_count: int = 0
    audit_checkpoint_count: int = 0
    plan_ready_for_future_execution_review: bool = False
...
class PlannedCommitExecutionPhase(BaseModel):
    phase_id: str
    phase_order: int = 0
    phase_type: str = "unknown"
    phase_status: str = "phase_planned"
    description: str = ""
    required: bool = True
    completed: bool = False
    execution_allowed: bool = False
...
class PlannedProgressExecutionStep(BaseModel):
    step_id: str
    source_progress_approval_id: str
    source_check_id: str
    target_type: str = "unknown"
    delta_kind: str = "unknown"
    step_type: str = "unknown"
    step_status: str = "step_planned"
    explicitly_approved_for_future_review: bool = False
    execution_allowed: bool = False
    executed: bool = False
    blockers: list[str] = Field(default_factory=list)
    warnings: list[str] = Field(default_factory=list)
...
class PlannedSurfaceExecutionStep(BaseModel):
    step_id: str
    source_surface_approval_id: str
    source_check_id: str
    surface_type: str = "unknown"
    update_kind: str = "unknown"
    step_type: str = "unknown"
...
class RuntimeCommitRollbackCheckpoint(BaseModel):
    checkpoint_id: str
...
class RuntimeCommitAuditCheckpoint(BaseModel):
    checkpoint_id: str
    checkpoint_type: str = "unknown"
    required: bool = True
    satisfied: bool = False
...
class RuntimeCommitExecutionPlanBlocker(BaseModel):
    blocker_id: str
    code: str
    severity: str = "blocked"
    message: str
...
class RuntimeCommitExecutionPlanValidationFinding(BaseModel):
    finding_id: str
    code: str
    severity: str = "info"
    message: str
...
class RuntimeCommitExecutionPlanWarning(BaseModel):
    code: str
    message: str
    severity: str = "warning"
    related_artifact_type: str | None = None
...
class SimuladoRuntimeCommitExecutionPlan(BaseModel):
    ...
    source_attempt_session_id: str | None = None
    source_simulado_blueprint_id: str | None = None
    execution_plan_mode: str = "execution_plan_only"
    execution_plan_status: str = "execution_plan_needs_review"
    readiness_state: str = "execution_plan_needs_review"
    plan_summary: RuntimeCommitExecutionPlanSummary
    planned_execution_phases: list[PlannedCommitExecutionPhase] = Field(default_factory=list)
    planned_progress_steps: list[PlannedProgressExecutionStep] = Field(default_factory=list)
    planned_surface_steps: list[PlannedSurfaceExecutionStep] = Field(default_factory=list)
    rollback_checkpoints: list[RuntimeCommitRollbackCheckpoint] = Field(default_factory=list)
    audit_checkpoints: list[RuntimeCommitAuditCheckpoint] = Field(default_factory=list)
    blockers: list[RuntimeCommitExecutionPlanBlocker] = Field(default_factory=list)
    validation_findings: list[RuntimeCommitExecutionPlanValidationFinding] = Field(
        default_factory=list
    )
    warnings: list[RuntimeCommitExecutionPlanWarning] = Field(default_factory=list)
    execution_plan_created: bool = True
    execution_plan_ready_for_future_execution_review: bool = False
    execution_allowed_now: bool = False
    execution_started: bool = False
    commit_execution_allowed: bool = False
    commit_execution_started: bool = False
...
class ControlledCommitExecutionSummary(BaseModel):
    summary_id: str
    source_plan_present: bool = True
    source_plan_created: bool = True
    source_plan_ready_for_future_execution_review: bool = False
    source_execution_allowed_now: bool = False
    source_execution_started: bool = False
    source_commit_executed: bool = False
    planned_phase_count: int = 0
    evaluated_phase_count: int = 0
    blocked_phase_count: int = 0
    planned_progress_step_count: int = 0
    evaluated_progress_step_count: int = 0
    blocked_progress_step_count: int = 0
    planned_surface_step_count: int = 0
    evaluated_surface_step_count: int = 0
    blocked_surface_step_count: int = 0
    rollback_verification_count: int = 0
    rollback_blocked_count: int = 0
    audit_verification_count: int = 0
    audit_blocked_count: int = 0
    controlled_execution_dry_run_complete: bool = True
    real_execution_performed: bool = False
    mutation_commit_performed: bool = False
    runtime_application_performed: bool = False
    unsafe_public_answer_key_exposure_detected: bool = False
    unsafe_gabarito_exposure_detected: bool = False
    metadata: dict[str, object] = Field(default_factory=dict)


class ControlledPhaseExecutionRecord(BaseModel):
    record_id: str
    source_phase_id: str
    phase_type: str = "unknown"
    phase_order: int = 0
    source_phase_status: str = "phase_planned"
    execution_record_status: str = "record_not_executed"
    evaluated: bool = True
    execution_allowed: bool = False
    executed: bool = False
    blocked: bool = True
...
class ControlledProgressStepExecutionRecord(BaseModel):
    record_id: str
    source_step_id: str
    source_progress_approval_id: str
    target_type: str = "unknown"
    delta_kind: str = "unknown"
    source_step_status: str = "step_planned"
    execution_record_status: str = "record_not_executed"
    evaluated: bool = True
    execution_allowed: bool = False
    executed: bool = False
    blocked: bool = True
    proposed_delta_summary: dict[str, object] = Field(default_factory=dict)
    blockers: list[str] = Field(default_factory=list)
    warnings: list[str] = Field(default_factory=list)
    metadata: dict[str, object] = Field(default_factory=dict)


class ControlledSurfaceStepExecutionRecord(BaseModel):
    record_id: str
    source_step_id: str
    source_surface_approval_id: str
    surface_type: str = "unknown"
    ...
    executed: bool = False
    blocked: bool = True
    proposed_surface_update_summary: dict[str, object] = Field(default_factory=dict)
    blockers: list[str] = Field(default_factory=list)
    warnings: list[str] = Field(default_factory=list)
    metadata: dict[str, object] = Field(default_factory=dict)


class ControlledRollbackVerificationRecord(BaseModel):
    record_id: str
...
class ControlledAuditVerificationRecord(BaseModel):
    record_id: str
    source_checkpoint_id: str
    checkpoint_type: str = "unknown"
    required: bool = True
...
class ControlledCommitExecutionAuditEntry(BaseModel):
    audit_id: str
    event_type: str
    actor_user_id: str | None = None
    message: str
...
class ControlledCommitExecutionBlocker(BaseModel):
    blocker_id: str
    code: str
    severity: str = "blocked"
    message: str
...
class ControlledCommitExecutionValidationFinding(BaseModel):
    finding_id: str
    code: str
    severity: str = "info"
    message: str
...
class ControlledCommitExecutionWarning(BaseModel):
    code: str
    message: str
    severity: str = "warning"
    related_artifact_type: str | None = None
...
class SimuladoControlledRuntimeCommitExecution(BaseModel):
    ...
    source_attempt_session_id: str | None = None
    source_simulado_blueprint_id: str | None = None
    execution_mode: str = "controlled_execution_dry_run"
    execution_status: str = "execution_needs_review"
    readiness_state: str = "controlled_execution_needs_review"
    execution_summary: ControlledCommitExecutionSummary
    phase_execution_records: list[ControlledPhaseExecutionRecord] = Field(default_factory=list)
    progress_step_execution_records: list[ControlledProgressStepExecutionRecord] = Field(
        default_factory=list
    )
    surface_step_execution_records: list[ControlledSurfaceStepExecutionRecord] = Field(
        default_factory=list
    )
    rollback_verification_records: list[ControlledRollbackVerificationRecord] = Field(
        default_factory=list
    )
    audit_verification_records: list[ControlledAuditVerificationRecord] = Field(
        default_factory=list
    )
    audit_trail: list[ControlledCommitExecutionAuditEntry] = Field(default_factory=list)
    blockers: list[ControlledCommitExecutionBlocker] = Field(default_factory=list)
    validation_findings: list[ControlledCommitExecutionValidationFinding] = Field(
        default_factory=list
    )
    warnings: list[ControlledCommitExecutionWarning] = Field(default_factory=list)
    controlled_execution_created: bool = True
    execution_started: bool = False
    ...
    no_adaptive_tuning_update: bool = True
    no_final_pedagogical_update_event: bool = True
    final_pedagogical_update_event_created: bool = False
    answer_key_publicly_exposed: bool = False
    gabarito_publicly_exposed: bool = False
    generated_at: datetime = Field(default_factory=utc_now)
    metadata: dict[str, object] = Field(default_factory=dict)
...
class AppliedEventLedgerSummary(BaseModel):
    summary_id: str
    ...
    idempotency_satisfied: bool = False
    deduplication_enforced: bool = True
    duplicate_event_detected: bool = False
...
class AppliedEventRecord(BaseModel):
    ...
    source_runtime_apply_policy_id: str
    source_final_event_id: str
    source_applied_progress_ledger_entry_id: str
    event_type: str = "minimal_progress_ledger_apply_recorded"
    event_scope: str = "minimal_progress_ledger"
    target_type: str = "unknown"
    target_id: str | None = None
    bounded_event_summary: dict[str, object] = Field(default_factory=dict)
    recorded: bool = True
...
class AppliedEventIdempotencyRecord(BaseModel):
    idempotency_key_required: bool = True
    idempotency_key_present: bool = False
    idempotency_key_valid: bool = False
    idempotency_key: str | None = None
...
class AppliedEventDeduplicationRecord(BaseModel):
    deduplication_enforced: bool = True
    deduplication_key: str
    duplicate_source_apply_detected: bool = False
    duplicate_event_detected: bool = False
    previous_ledger_id: str | None = None
...
class AppliedEventReplaySafetyRecord(BaseModel):
    replay_safe: bool = True
    replay_count: int = 0
    replay_returns_existing_ledger: bool = True
    same_source_same_key_idempotent: bool = True
    no_duplicate_event_records: bool = True
    metadata: dict[str, object] = Field(default_factory=dict)


class AppliedEventRollbackReference(BaseModel):
    rollback_required: bool = True
    rollback_reference_preserved: bool = False
    rollback_scope: str = "minimal_progress_ledger"
    rollback_executed: bool = False
...
class AppliedEventLedgerAuditEntry(BaseModel):
    audit_id: str
    event_type: str
    actor_user_id: str | None = None
    message: str
...
class AppliedEventLedgerBlocker(BaseModel):
    blocker_id: str
    code: str
    severity: str = "blocked"
    message: str
...
class AppliedEventLedgerValidationFinding(BaseModel):
    finding_id: str
    code: str
    severity: str = "info"
    message: str
...
class AppliedEventLedgerWarning(BaseModel):
    code: str
    message: str
    severity: str = "warning"
    related_artifact_type: str | None = None
...
class SimuladoAppliedEventLedger(BaseModel):
    ...
    source_attempt_session_id: str | None = None
    source_simulado_blueprint_id: str | None = None
    ledger_mode: str = "applied_event_ledger"
    ledger_status: str = "ledger_blocked"
    readiness_state: str = "blocked_by_source_apply_not_applied"
    ledger_summary: AppliedEventLedgerSummary
    applied_event_records: list[AppliedEventRecord] = Field(default_factory=list)
    idempotency_record: AppliedEventIdempotencyRecord
    deduplication_record: AppliedEventDeduplicationRecord
    replay_safety_record: AppliedEventReplaySafetyRecord
    rollback_reference: AppliedEventRollbackReference
    audit_trail: list[AppliedEventLedgerAuditEntry] = Field(default_factory=list)
    blockers: list[AppliedEventLedgerBlocker] = Field(default_factory=list)
    validation_findings: list[AppliedEventLedgerValidationFinding] = Field(default_factory=list)
    warnings: list[AppliedEventLedgerWarning] = Field(default_factory=list)
    applied_event_ledger_created: bool = True
    ledger_event_recorded: bool = False
    ledger_event_count: int = 0
    source_minimal_progress_ledger_apply_present: bool = True
    source_minimal_progress_ledger_apply_applied: bool = False
    source_applied_progress_ledger_entry_count: int = 0
    idempotency_key_required: bool = True
    idempotency_key_present: bool = False
    idempotency_key_valid: bool = False
    idempotency_key: str | None = None
