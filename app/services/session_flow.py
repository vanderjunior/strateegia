    ...
    def _question_block_for_candidate(
        ...
        *,
        ...
        return {
            ...
            "empirical_dataset_state": executed.get("empirical_dataset_state"),
            "empirical_dataset_summary": executed.get("empirical_dataset_summary"),
            "empirical_dataset_reasoning": executed.get("empirical_dataset_reasoning"),
            "validation_case_results": executed.get("validation_case_results"),
            "passed_cases": executed.get("passed_cases"),
            "failed_cases": executed.get("failed_cases"),
            "inconclusive_cases": executed.get("inconclusive_cases"),
            "dataset_alignment_score": executed.get("dataset_alignment_score"),
            "dataset_regression_flags": executed.get("dataset_regression_flags"),
            "dataset_coverage_summary": executed.get("dataset_coverage_summary"),
            "empirical_validation_context": executed.get("empirical_validation_context"),
            "why_this_dataset_result": executed.get("why_this_dataset_result"),
            "pedagogical_benchmark_state": executed.get("pedagogical_benchmark_state"),
            "pedagogical_benchmark_summary": executed.get("pedagogical_benchmark_summary"),
            "pedagogical_benchmark_reasoning": executed.get("pedagogical_benchmark_reasoning"),
            "benchmark_case_reports": executed.get("benchmark_case_reports"),
            "benchmark_total_cases": executed.get("benchmark_total_cases"),
            "benchmark_passed_cases": executed.get("benchmark_passed_cases"),
            "benchmark_failed_cases": executed.get("benchmark_failed_cases"),
            "benchmark_inconclusive_cases": executed.get("benchmark_inconclusive_cases"),
            "benchmark_regression_cases": executed.get("benchmark_regression_cases"),
            "benchmark_regression_flags": executed.get("benchmark_regression_flags"),
            "benchmark_regression_severity": executed.get("benchmark_regression_severity"),
            "benchmark_readiness": executed.get("benchmark_readiness"),
            "benchmark_alignment_score": executed.get("benchmark_alignment_score"),
            "benchmark_coverage_summary": executed.get("benchmark_coverage_summary"),
            "why_this_benchmark_result": executed.get("why_this_benchmark_result"),
