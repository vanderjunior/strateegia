...
- Ciclo, Questões, Simulados, Execução, automatic/material-level progress, and multi-material study cycles are not real user capabilities yet; they remain gated or future placeholders until later contracts exist.
