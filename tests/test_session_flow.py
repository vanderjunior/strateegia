...
def test_session_blocks_expose_pedagogical_metadata(tmp_path):
    ...
    assert "pedagogical_expression_mode" in summary_block
    ...
    assert "session_snapshot_state" in summary_block
    ...
    assert "pedagogical_benchmark_state" in summary_block
    assert "pedagogical_benchmark_summary" in summary_block
    ...
    assert "pedagogical_expression_mode" in question_block
    ...
    assert "behavioral_diff_state" in question_block
    ...
    assert "pedagogical_benchmark_state" in question_block
    assert "benchmark_case_reports" in question_block
